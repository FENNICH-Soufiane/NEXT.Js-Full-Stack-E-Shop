      ...
      <Container>
         <div className="flex flex-col md:flex-row justify-between pt-16 pb-8">
            ...
            <div className="w-full md:w-1/3 mb-6 md:mb-0">
               <h3 className="text-base font-bold mb-3">Customer Service</h3>
               <p className="mb-2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eum ab sapiente minus voluptatibus enim autem, nulla, aliquid soluta obcaecati sunt aliquam ratione accusamus est, quis libero itaque suscipit ducimus non!</p>
